...
CountDown::CountDown()
{
	CountDown3.reset(Sprite::Create(8, { WinApp::window_width + WinApp::window_width / 2.0f,WinApp::window_height / 2.0f }));
	CountDown2.reset(Sprite::Create(7, { WinApp::window_width + WinApp::window_width / 2.0f,WinApp::window_height / 2.0f }));
	CountDown1.reset(Sprite::Create(6, { WinApp::window_width + WinApp::window_width / 2.0f,WinApp::window_height / 2.0f }));
	CountDownStart.reset(Sprite::Create(11, { WinApp::window_width + WinApp::window_width / 2.0f,WinApp::window_height / 2.0f }));
}
